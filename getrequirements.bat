...
python -m pip install requests pycryptodome discord.py opencv-python pyperclip pillow uuid imageio pywin32 pynput pyaudio pyautogui aiohttp numpy screeninfo GPUtil psutil pyinstaller --quiet
